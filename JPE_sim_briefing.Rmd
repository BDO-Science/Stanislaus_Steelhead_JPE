...
df <- read.csv('Files/Param_dist.csv')
JPE_all <- read.csv('Files/JPE_sims.csv')
params <- read.csv('Files/Params.csv')
...
## Results
As expected, there is increased variation in the adult approach compared to the juvenile approach.  For the adult approach, estimates range from approximately `r prettyNum(round(summary[1,2],0), big.mark = ',', scientific = FALSE)` to `r prettyNum(round(summary[1,3],0), big.mark = ',', scientific = FALSE)` individuals, with lower and upper quantiles between approximately `r prettyNum(round(summary[1,4],0), big.mark = ',', scientific = FALSE)` and `r prettyNum(round(summary[1,5],0), big.mark = ',', scientific = FALSE)` individuals.  For the juvenile approach, the estimates were much less variant and range from approximately `r prettyNum(round(summary[2,2],0), big.mark = ',', scientific = FALSE)` to `r prettyNum(round(summary[2,3],0), big.mark = ',', scientific = FALSE)`, with lower and upper quantiles between approximately `r prettyNum(round(summary[2,4],0), big.mark = ',', scientific = FALSE)` and `r prettyNum(round(summary[2,5],0), big.mark = ',', scientific = FALSE)` individuals.
